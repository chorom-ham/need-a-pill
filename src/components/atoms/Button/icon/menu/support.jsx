...
export default function Icon({ style, fill }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" style={style}>
      ...
      <g transform="translate(2.452 1.199)" clipPath="url(#1a)">
        <g transform="translate(-2.452 -.817)" clipPath="url(#2b)">
          <g clipPath="url(#3c)" transform="translate(-1.25 -2.881)">
            <g transform="translate(3.702 3.698)" clipPath="url(#4d)">
              <path d="M-4.087-4.087h22.889v26.159H-4.087z" />
            </g>
            <g transform="translate(1.25 2.881)" clipPath="url(#5e)">
              <g transform="translate(2.452 .817)" clipPath="url(#4d)">
